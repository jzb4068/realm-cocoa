...
public final class List<T: RealmManaged>: ListBase {
    ...
    public func index(of object: T) -> Int? {
        return notFoundToNil(index: _rlmArray.index(of: object))
    }
    ...
    public subscript(position: Int) -> T {
        ...
        set {
            throwForNegativeIndex(position)
            _rlmArray.replaceObject(at: UInt(position), with: newValue)
        }
    }
    ...
    public func insert(_ object: T, at index: Int) {
        ...
        _rlmArray.insert(object, at: UInt(index))
    }
    ...
    public func replace(index: Int, object: T) {
        throwForNegativeIndex(index)
        _rlmArray.replaceObject(at: UInt(index), with: object)
    }
